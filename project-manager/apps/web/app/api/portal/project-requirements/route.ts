...
import { portalProjectRequirementsPatchBodySchema } from "@/lib/portal-project-requirements";
...
export async function PATCH(request: NextRequest) {
  ...
  const parsed = portalProjectRequirementsPatchBodySchema.safeParse(json);
  if (!parsed.success) {
