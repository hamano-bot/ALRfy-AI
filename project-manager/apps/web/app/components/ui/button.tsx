  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        accent:
          "border border-[color:color-mix(in_srgb,var(--accent)_55%,white_45%)] bg-[linear-gradient(120deg,color-mix(in_srgb,var(--accent)_85%,#1d4ed8_15%),color-mix(in_srgb,var(--accent)_72%,#4338ca_28%))] text-[var(--accent-contrast)] hover:brightness-110",
        ghost:
