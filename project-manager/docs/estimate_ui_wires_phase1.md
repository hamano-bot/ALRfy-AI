...
+------------------------------------------------------------------------------------------------------+
| 明細入力                                                                                               |
| [テンプレ読込] [テンプレ保存(個人)] [テンプレ保存(全体)] [行複製] [大項目追加] [行追加] [全行: 人月→人日] [全行: 人日→人月] |
| 大項目: 要件定義/設計, SITEMANAGEライセンス, 公開側制作, 開発, その他                                 |
| SITEMANAGEライセンス選択時: [添付ファイル読込] [テキスト一括貼り付け]                                  |
|------------------------------------------------------------------------------------------------------|
| 移動 | 区分 | 項目名 | 数量 | 単位(人月or人日/式/ページ/回/%) | 単価 | 係数 | 金額(自動) | 削除           |
|------------------------------------------------------------------------------------------------------|
| [掴] | 要件 | 要件定義 | 5.0  | 人日                       | 60000| 1.0  | 300000     | [x]            |
|      |      | ---- ドロップ先ハイライト ----                                                            |
| ...                                                                                                   |
+------------------------------------------------------------------------------------------------------+
| 区分/項目名サジェスト                                                                                   |
...
| - SITEMANAGEライセンス大項目では、PDF（2026年度SITEMANAGE価格表）に含まれるプラグイン名を一括読込可能    |
| - 一括入力方法は「添付ファイル読込」または「テキスト一括貼り付け」の2択                                |
| - 一括読込時はプラグイン名（項目名）に一致する単価を同時に自動セットする                                  |
| - 例:                                                                                                  |
|   標準候補: 要件定義                                                                                    |
|     履歴候補:   要件定義（軽微改修）                                                                    |
|   標準候補: 開発                                                                                        |
...
- PDF出力は編集画面ではなく、見積プレビュー/HTML出力画面の主操作として配置する
...
- `SITEMANAGEライセンス` 大項目は、価格表PDF由来のプラグイン一覧を一括展開でき、各行の `項目名` と `単価` を同時入力する
- 一括展開の入力手段は「添付ファイル読込」または「テキスト一括貼り付け」を提供する
